...
def data_load(data_name, args):
    ...
    if args.aug_traindata > 0:
        ...
        original_train, _, _ = load_file_and_sort(original_train_file)
        aug_data_signature = './aug_data/{}/lr_{}_maxlen_{}_nblocks_{}_drate_{}_l2_{}_nheads_{}_gen_num_'.format(args.dataset, args.lr, args.maxlen, args.num_blocks, args.dropout_rate, args.l2_emb, args.num_heads)
